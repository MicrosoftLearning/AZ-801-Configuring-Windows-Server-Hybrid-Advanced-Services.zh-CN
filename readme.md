---
ms.openlocfilehash: 18a8b69783caa31571ab13a12ff3f55e63341892
ms.sourcegitcommit: 9a51ea796ef3806ab9e7ec1ff75034b2f929ed2a
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/28/2022
ms.locfileid: "137907086"
---
...
- 为支持此课程，我们需要经常更新课程内容，以使其与课程中使用的 Azure 服务保持同步。  我们正在 GitHub 上发布实验室说明和实验室文件，以允许课程作者和 MCT 之间以开放的方式做出贡献，使内容与 Azure 平台中的更改保持同步。

- 我们希望这会给实验室带来前所未有的协作感 - 当 Azure 发生变化并且你在实时交付期间首先发现它时，请继续在实验室源中进行增强。  帮助你的 MCT 朋友。
...
- GitHub 上的这些文件旨在与学生手册一起使用，但在 GitHub 中是中心存储库，因此 MCT 和课程作者可以拥有最新实验室文件的共享源。

- 建议每次交付时，培训师检查 GitHub 是否为支持最新的 Azure 服务进行了任何更改，并获取最新的交付文件。

## <a name="what-about-changes-to-the-student-handbook"></a>学生手册有什么变化？

- 我们将按季度审核学员手册，并根据需要通过标准 MOC 版本通道进行更新。

## <a name="how-do-i-contribute"></a>如何做出贡献？

- 任何 MCT 都可向 GitHub 存储库中的代码或内容提交拉取请求，Microsoft 和课程作者将根据需要对内容和实验室代码更改进行分类并包括在内。

- 你可以提交 bug、更改、改进和想法。  先于我们找到新的 Azure 功能？  提交新演示！
