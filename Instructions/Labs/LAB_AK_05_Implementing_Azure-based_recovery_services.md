...
1. 在“**Microsoft Azure 恢复服务代理安装向导**”的“**Microsoft 更新选择加入**”页上，选择“**我不想使用 Windows 更新**”，然后选择“**下一步**”。
...
1. 在“**注册服务器向导**”的“**加密设置**”页上，取消选中“**将密码安全地保存到 Azure 密钥保管库**”并选择“**是**”，确认要继续操作而不将密码保存到 Azure 密钥保管库。
   
   > **备注**：在生产环境中，我们建议使用 Azure 密钥保管库功能，但出于实验室的目的，我们将在本地保存密码。

1. 在“**注册服务器向导**”的“**加密设置**”页上，选择“**生成密码**”。
